...
void overlay(QuadtreeNode *node1, QuadtreeNode *node2, QuadtreeNode **rez)
{
	...
	else if (node1->top_left == NULL && node2->top_left != NULL)
	{
...
int main(int argc, char *argv[])
{
	...
	if (strcmp(argv[1], "-c") == 0)
	{
		...
		rgb_t **a = (rgb_t **)malloc(sizeof(rgb_t *) * (256));
		for (i = 0; i < (256); i++)
		{
			a[i] = malloc(sizeof(rgb_t) * (256));
			fwrite(a[i], sizeof(rgb_t), (256), f);
		}
...
// https://github.com/dibiex/quadtree-compress/blob/master/quadtree.c